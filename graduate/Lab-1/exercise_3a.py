...
# change the depreciation rate and recompute the new steady state values
model.args['delta'] = 0.01
...
ax_new.set_title(r'A fall in $\delta$ leads to a rise in $k^*$!', fontsize=20,
                 family='serif')
