...
bdf1_traj = model.integrate(0, k0, 1.0, T=100, integrator='backward_euler')

bdf2_traj = model.integrate(0, k0, 1.0, T=100, integrator='bdf2')

bdf3_traj = model.integrate(0, k0, 1.0, T=100, integrator='bdf3')

bdf4_traj = model.integrate(0, k0, 1.0, T=100, integrator='bdf4')

bdf5_traj = model.integrate(0, k0, 1.0, T=100, integrator='bdf5')
...
traj_error = model.plot_approximation_error(bdf1_traj, 
                                            analytic_trajectory, 
                                            log=True)[1]
...
traj_error1 = model.plot_approximation_error(bdf2_traj, 
                                             analytic_trajectory, 
                                             log=True)[1]
...
traj_error2 = model.plot_approximation_error(bdf3_traj, 
                                             analytic_trajectory, 
                                             log=True)[1]
...
traj_error3 = model.plot_approximation_error(bdf4_traj, 
                                             analytic_trajectory, 
                                             log=True)[1]
...
traj_error4 = model.plot_approximation_error(bdf5_traj, 
                                             analytic_trajectory, 
                                             log=True)[1]
...
plt.title('Solow (1956) approximation error using\n' + 
          'BDF methods, $h=1.0$', fontsize=20, family='serif')
plt.legend(loc='best', frameon=False, prop={'family':'serif'})
plt.savefig('graphics/solow-approximation-error-bdf-methods.pdf')
plt.show() 