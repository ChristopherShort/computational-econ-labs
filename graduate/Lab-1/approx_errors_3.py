...
for order in range(1,6):
    kwargs={'method':'bdf', 'order':order, 'with_jacobian':True}
    ...
    traj_error = model.plot_approximation_error(vode_traj, 
                                                analytic_trajectory, 
                                                log=True)[1]
...
plt.savefig('graphics/solow-approximation-error-3.png')
plt.show()